# Name: Kerry Flowers
# Prog Purpose: This program reads a coma-delimited data file into a LIST of smaller lists.
...
def read_data_file():
    ...
    for i in lines:
        stu.append(i.split(",")) #Split the data by commas and add each section the list
    datafile.close()
...
def create_report_file():
    ...
    repfile.write("nReport Date/Time         : " + str(datetime.datetime.now()))
    repfile.write("nTotal numebr of students: " + str(len(stu)))
